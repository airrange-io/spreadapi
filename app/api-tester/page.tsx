...
import { SendOutlined, ClearOutlined, ThunderboltOutlined, DatabaseOutlined, ClockCircleOutlined, CopyOutlined, CodeOutlined, ApiOutlined, KeyOutlined } from '@ant-design/icons';
      ...
      >
        <div style={{
          ...
          <Space direction="vertical" style={{ width: '100%' }} size="middle">
            ...
            <Text code style={{ fontSize: '14px', display: 'block', padding: '8px', background: 'white', borderRadius: '4px' }}>
              {endpoint}
            </Text>
            {requireToken && (
              <Alert
