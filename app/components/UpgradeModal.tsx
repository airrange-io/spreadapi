...
const allPlans: Record<string, PlanConfig> = {
  free: {
    ...
    price: '€0',
    color: '#8c8c8c',
    features: ['Unlimited APIs', 'Each publish live for 6h', '3 MB file size'],
    stripeLink: '',
    buttonLabel: 'Select',
  },
  pro: {
    ...
    price: '€99',
    color: '#722ed1',
    features: ['Services stay online', '1,000 calls/month', '3 MB file size'],
  ...
  premium: {
    ...
    price: '€299',
    color: '#d48806',
    features: ['Services stay online', '10,000 calls/month', '25 MB file size'],
