...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // Metadata can be localized in the future
  return {
    ...
    openGraph: {
      ...
      type: 'article',
      url: `https://spreadapi.com/${locale}/automation-calculations`,
      siteName: 'SpreadAPI',
      images: [{
...
export default async function AutomationCalculationsPage({ params }: PageProps) {
  const { locale } = await params;
    ...
    <>
      ...
      <div className="product-page">
        <div className="page-wrapper">
          <Navigation currentPage="automation-calculations" locale={typedLocale} />
