...
export interface TemplateOutput {
  name: string;
  address: string;        // e.g. "Sheet1!C5" or "Sheet1!C2:C10"
  row: number;
  col: number;
...
export interface Template {
  ...
  fileUrl: string;        // Vercel Blob URL for the workbook (.sjs or .json)
...
export const templates: Template[] = [
  {
    ...
    inputs: [
      // { name: 'param1', address: 'Sheet1!B2', row: 1, col: 1, dataType: 'number' },
    ],
    outputs: [
      // { name: 'result', address: 'Sheet1!C5', row: 4, col: 2 },
    ],
  },
  {
