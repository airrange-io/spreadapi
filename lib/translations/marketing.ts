...
export const whyAIFailsPage = {
  en: {
    ...
    bottomLine: {
      ...
      ctaNote: 'No credit card required • Free to build & test',
    },
  },
...
export const pricingPage = {
  en: {
    ...
    free: {
      ...
      features: [
        'Create unlimited Excel APIs',
        'Each publish stays live for 6 hours',
        'AI Integration (MCP)',
        'Max file size: 3 MB',
        'Basic support',
      ],
    ...
    pro: {
      ...
      features: [
        'Services stay online permanently',
  ...
  de: {
    ...
    free: {
      ...
      features: [
        'Beliebig viele Excel-APIs erstellen',
        'Jeder Publish bleibt 6 Stunden live',
        'KI-Integration (MCP)',
        'Max. Dateigröße: 3 MB',
        'Basis-Support',
      ],
    ...
    pro: {
      ...
      features: [
        'Services bleiben dauerhaft online',
...
// MCP Server page translations
export const mcpServerPage = {
  en: {
    hero: {
      subheading: 'Model Context Protocol',
      title: 'MCP Server for Excel —',
      titleHighlight: 'Connect AI to Your Spreadsheets',
      description: "AI assistants hallucinate math. Excel doesn't. SpreadAPI's MCP Server lets ChatGPT, Claude, and other AI tools call your real Excel formulas — delivering accurate results every time.",
      ctaPrimary: 'Get Started Free',
      ctaSecondary: 'See How It Works',
    },
    problem: {
      title: 'Why AI Needs an',
      titleHighlight: 'MCP Server for Excel',
      description: "Large Language Models are powerful at understanding language, but they cannot reliably execute spreadsheet formulas. When ChatGPT tries to calculate a mortgage payment or insurance premium, it guesses. Sometimes it's close. Often it's dangerously wrong.",
      withoutMcp: {
        title: 'Without MCP',
        question: "What's my monthly payment for a $300k loan at 4.5% over 30 years?",
        result: 'AI guesses: $1,520.06',
        note: 'Wrong. The correct answer is $1,520.06 only if using specific amortization assumptions. Different formula implementations yield different results. The AI has no way to know which is correct.',
      },
      withMcp: {
        title: 'With SpreadAPI MCP',
        description: 'AI calls your Excel model via MCP. Your PMT formula runs. The exact result comes back.',
        result: 'Excel calculates: $1,520.06',
        note: '100% accurate. Same result as your validated Excel model. Every time. Auditable. Compliant.',
      },
    },
    whatIsMcp: {
      title: 'What is',
      titleHighlight: 'MCP',
      titleSuffix: '(Model Context Protocol)?',
      description1: 'MCP is an open protocol created by Anthropic that standardizes how AI assistants connect to external tools and data sources. Think of it as a USB port for AI — a universal way to plug in capabilities.',
      description2: 'Instead of building custom integrations for each AI tool, you create one MCP Server, and any compatible AI assistant can use it. SpreadAPI automatically generates this MCP Server for every Excel spreadsheet you publish.',
      point1: 'Open standard',
      point1Suffix: '— not locked to one AI vendor',
      point2: 'Auto-discovery',
      point2Suffix: '— AI learns what your spreadsheet can do',
      point3: 'Secure',
      point3Suffix: '— granular permissions, encrypted communication',
      diagramLabel: 'MCP architecture diagram showing AI assistants connecting to Excel via SpreadAPI',
      diagramAiLabel: 'Claude / ChatGPT',
      diagramProtocol: 'MCP Protocol',
      diagramServer: 'SpreadAPI MCP Server',
      diagramServerDetail: 'Auto-discovery \u2022 Auth \u2022 Rate Limiting',
      diagramLoan: 'Loan Calculator',
      diagramPricing: 'Pricing Engine',
      diagramPrivate1: 'Formulas',
      diagramPrivate2: 'stay private',
    },
    setup: {
      subheading: 'Setup in 5 Minutes',
      title: 'How to Set Up an',
      titleHighlight: 'MCP Server',
      titleSuffix: 'for Excel',
      step1Title: 'Upload Your Excel File',
      step1Desc: 'Upload your spreadsheet to SpreadAPI. Define which cells are inputs (the parameters AI will send) and which are outputs (the results AI will receive). Supports XLSX with formulas, VLOOKUP, pivot tables, and more.',
      step2Title: 'Publish with MCP Enabled',
      step2Desc: 'Click publish. SpreadAPI creates a REST API endpoint and automatically generates an MCP-compatible server. No configuration files to write, no Docker containers to manage.',
      step3Title: 'Connect Your AI Assistant',
      step3Desc: "Copy the MCP URL into Claude Desktop, ChatGPT, or any MCP-compatible client. The AI instantly discovers your spreadsheet's capabilities and can call calculations in real time.",
      cta: 'Try It Free — No Credit Card',
    },
    useCases: {
      title: 'Use Cases: When',
      titleHighlight: 'AI + Excel',
      titleSuffix: 'Changes Everything',
      description: 'Any scenario where AI needs to do real math is a use case for MCP + SpreadAPI.',
      financial: 'Financial Modeling',
      financialDesc: 'Loan calculators, mortgage quotes, ROI projections. AI uses your validated Excel model to give customers precise numbers — not approximations.',
      pricing: 'Dynamic Pricing',
      pricingDesc: 'Insurance premiums, SaaS pricing tiers, wholesale discounts. Your pricing logic stays in Excel where your team maintains it. AI just calls it.',
      engineering: 'Engineering Calculations',
      engineeringDesc: 'Material stress analysis, load calculations, unit conversions. AI provides the interface, Excel provides the engineering precision.',
      tax: 'Tax & Compliance',
      taxDesc: 'Tax estimators, VAT calculators, regulatory calculations. Keep your compliance-validated spreadsheet as the single source of truth.',
      sales: 'Sales Quoting',
      salesDesc: 'Let AI assistants generate accurate quotes by calling your Excel pricing model. No more manual lookups or copy-paste errors.',
      validation: 'Data Validation',
      validationDesc: 'Cross-reference user inputs against your Excel models. AI validates data in real time using your business rules — no custom code needed.',
    },
    comparison: {
      title: 'MCP vs.',
      titleHighlight: 'Traditional API Integration',
      feature: 'Feature',
      traditional: 'Traditional API',
      mcp: 'MCP Server',
      setupTime: 'Setup time',
      setupTraditional: 'Hours to days',
      setupMcp: '5 minutes',
      codeRequired: 'Code required',
      codeTraditional: 'Custom integration code',
      codeMcp: 'Zero code',
      aiDiscovery: 'AI discovery',
      discoveryTraditional: 'Manual documentation',
      discoveryMcp: 'Automatic',
      worksWith: 'Works with',
      worksTraditional: 'One specific AI tool',
      worksMcp: 'Any MCP client',
      maintenance: 'Maintenance',
      maintenanceTraditional: 'Update code when API changes',
      maintenanceMcp: 'Update Excel, done',
    },
    claudeExample: {
      title: 'Example:',
      titleHighlight: 'Claude Desktop',
      titleSuffix: '+ Excel',
      description: "Here's what happens when Claude uses your Excel loan calculator via MCP. The AI asks your spreadsheet — not itself — for the answer.",
      point1: 'AI sends parameters to your Excel model',
      point2: 'Excel formulas calculate the real result',
      point3: 'AI presents the precise answer naturally',
      youAsk: 'You ask Claude:',
      question: 'What would my monthly payment be for a $300,000 mortgage at 4.5% over 30 years?',
      claudeCalls: 'Claude calls your MCP Server:',
      claudeResponds: "Claude responds with Excel's result:",
      response: 'Based on your loan calculator, your monthly payment would be <strong>$1,520.06</strong>. Over 30 years, you\'d pay $547,220.13 in total, of which $247,220.13 is interest.',
    },
    learnMore: {
      title: 'Learn More',
      devGuide: 'MCP Protocol: Developer Guide',
      devGuideDesc: 'Deep dive into setting up MCP with code examples and best practices.',
      claudeGuide: 'Claude Desktop + Excel Guide',
      claudeGuideDesc: 'Step-by-step tutorial for connecting Claude Desktop to your spreadsheets.',
      excelToApi: 'Excel to API Guide',
      excelToApiDesc: 'Convert any spreadsheet to a REST API in minutes. Compare alternatives.',
    },
    faq: {
    ...
    cta: {
      title: 'Ready to Connect AI to Your Spreadsheets?',
      description: 'Set up your MCP Server in 5 minutes. Free tier available.',
      button: 'Get Started Free',
    },
  },
  de: {
    hero: {
      subheading: 'Model Context Protocol',
      title: 'MCP Server für Excel —',
      titleHighlight: 'Verbinden Sie KI mit Ihren Tabellen',
      description: 'KI-Assistenten halluzinieren bei Mathematik. Excel nicht. Der MCP Server von SpreadAPI ermöglicht es ChatGPT, Claude und anderen KI-Tools, Ihre echten Excel-Formeln aufzurufen — mit präzisen Ergebnissen, jedes Mal.',
      ctaPrimary: 'Kostenlos starten',
      ctaSecondary: 'So funktioniert es',
    },
    problem: {
      title: 'Warum KI einen',
      titleHighlight: 'MCP Server für Excel',
      description: 'Large Language Models sind leistungsstark im Sprachverständnis, können aber Tabellenformeln nicht zuverlässig ausführen. Wenn ChatGPT eine Hypothekenrate oder Versicherungsprämie berechnen soll, rät es. Manchmal ist es nah dran. Oft ist es gefährlich falsch.',
      withoutMcp: {
        title: 'Ohne MCP',
        question: 'Wie hoch ist meine monatliche Rate für ein Darlehen über 300.000 $ bei 4,5 % über 30 Jahre?',
        result: 'KI rät: $1.520,06',
        note: 'Falsch. Die korrekte Antwort ist $1.520,06 nur bei bestimmten Tilgungsannahmen. Verschiedene Formelimplementierungen liefern unterschiedliche Ergebnisse. Die KI hat keine Möglichkeit zu wissen, welches korrekt ist.',
      },
      withMcp: {
        title: 'Mit SpreadAPI MCP',
        description: 'KI ruft Ihr Excel-Modell über MCP auf. Ihre PMT-Formel wird ausgeführt. Das exakte Ergebnis kommt zurück.',
        result: 'Excel berechnet: $1.520,06',
        note: '100 % genau. Dasselbe Ergebnis wie Ihr validiertes Excel-Modell. Jedes Mal. Prüfbar. Konform.',
      },
    },
    whatIsMcp: {
      title: 'Was ist',
      titleHighlight: 'MCP',
      titleSuffix: '(Model Context Protocol)?',
      description1: 'MCP ist ein offenes Protokoll von Anthropic, das standardisiert, wie KI-Assistenten sich mit externen Tools und Datenquellen verbinden. Stellen Sie es sich wie einen USB-Anschluss für KI vor — ein universeller Weg, Funktionen einzubinden.',
      description2: 'Statt individuelle Integrationen für jedes KI-Tool zu erstellen, bauen Sie einen MCP Server, und jeder kompatible KI-Assistent kann ihn nutzen. SpreadAPI generiert diesen MCP Server automatisch für jede veröffentlichte Excel-Tabelle.',
      point1: 'Offener Standard',
      point1Suffix: '— nicht an einen KI-Anbieter gebunden',
      point2: 'Auto-Discovery',
      point2Suffix: '— KI erkennt, was Ihre Tabelle kann',
      point3: 'Sicher',
      point3Suffix: '— granulare Berechtigungen, verschlüsselte Kommunikation',
      diagramLabel: 'MCP-Architekturdiagramm: KI-Assistenten verbinden sich über SpreadAPI mit Excel',
      diagramAiLabel: 'Claude / ChatGPT',
      diagramProtocol: 'MCP-Protokoll',
      diagramServer: 'SpreadAPI MCP Server',
      diagramServerDetail: 'Auto-Discovery \u2022 Auth \u2022 Rate Limiting',
      diagramLoan: 'Kreditrechner',
      diagramPricing: 'Preis-Engine',
      diagramPrivate1: 'Formeln',
      diagramPrivate2: 'bleiben privat',
    },
    setup: {
      subheading: 'Einrichtung in 5 Minuten',
      title: 'So richten Sie einen',
      titleHighlight: 'MCP Server',
      titleSuffix: 'für Excel ein',
      step1Title: 'Excel-Datei hochladen',
      step1Desc: 'Laden Sie Ihre Tabelle auf SpreadAPI hoch. Definieren Sie, welche Zellen Eingaben sind (die Parameter, die KI sendet) und welche Ausgaben (die Ergebnisse, die KI erhält). Unterstützt XLSX mit Formeln, SVERWEIS, Pivot-Tabellen und mehr.',
      step2Title: 'Mit MCP veröffentlichen',
      step2Desc: 'Klicken Sie auf Veröffentlichen. SpreadAPI erstellt einen REST-API-Endpunkt und generiert automatisch einen MCP-kompatiblen Server. Keine Konfigurationsdateien, keine Docker-Container.',
      step3Title: 'KI-Assistenten verbinden',
      step3Desc: 'Kopieren Sie die MCP-URL in Claude Desktop, ChatGPT oder einen beliebigen MCP-kompatiblen Client. Die KI erkennt sofort die Möglichkeiten Ihrer Tabelle und kann Berechnungen in Echtzeit abrufen.',
      cta: 'Kostenlos testen — keine Kreditkarte',
    },
    useCases: {
      title: 'Anwendungsfälle: Wenn',
      titleHighlight: 'KI + Excel',
      titleSuffix: 'alles verändert',
      description: 'Jedes Szenario, in dem KI echte Mathematik benötigt, ist ein Anwendungsfall für MCP + SpreadAPI.',
      financial: 'Finanzmodellierung',
      financialDesc: 'Kreditrechner, Hypothekenangebote, ROI-Projektionen. KI nutzt Ihr validiertes Excel-Modell für präzise Zahlen — keine Annäherungen.',
      pricing: 'Dynamische Preisgestaltung',
      pricingDesc: 'Versicherungsprämien, SaaS-Preisstufen, Großhandelsrabatte. Ihre Preislogik bleibt in Excel, wo Ihr Team sie pflegt. KI ruft sie nur ab.',
      engineering: 'Ingenieurberechnungen',
      engineeringDesc: 'Materialspannungsanalyse, Lastberechnungen, Einheitenumrechnungen. KI bietet die Oberfläche, Excel die Ingenieursgenauigkeit.',
      tax: 'Steuern & Compliance',
      taxDesc: 'Steuerrechner, Umsatzsteuer-Rechner, regulatorische Berechnungen. Ihre compliance-validierte Tabelle bleibt die einzige Quelle der Wahrheit.',
      sales: 'Angebotserstellung',
      salesDesc: 'KI-Assistenten erstellen präzise Angebote durch Aufruf Ihres Excel-Preismodells. Keine manuellen Nachschlagungen oder Kopierfehler mehr.',
      validation: 'Datenvalidierung',
      validationDesc: 'Gleichen Sie Benutzereingaben mit Ihren Excel-Modellen ab. KI validiert Daten in Echtzeit anhand Ihrer Geschäftsregeln — ohne individuellen Code.',
    },
    comparison: {
      title: 'MCP vs.',
      titleHighlight: 'Traditionelle API-Integration',
      feature: 'Funktion',
      traditional: 'Traditionelle API',
      mcp: 'MCP Server',
      setupTime: 'Einrichtungszeit',
      setupTraditional: 'Stunden bis Tage',
      setupMcp: '5 Minuten',
      codeRequired: 'Code erforderlich',
      codeTraditional: 'Individueller Integrationscode',
      codeMcp: 'Kein Code',
      aiDiscovery: 'KI-Erkennung',
      discoveryTraditional: 'Manuelle Dokumentation',
      discoveryMcp: 'Automatisch',
      worksWith: 'Funktioniert mit',
      worksTraditional: 'Einem bestimmten KI-Tool',
      worksMcp: 'Jedem MCP-Client',
      maintenance: 'Wartung',
      maintenanceTraditional: 'Code bei API-Änderungen aktualisieren',
      maintenanceMcp: 'Excel aktualisieren, fertig',
    },
    claudeExample: {
      title: 'Beispiel:',
      titleHighlight: 'Claude Desktop',
      titleSuffix: '+ Excel',
      description: 'So sieht es aus, wenn Claude Ihren Excel-Kreditrechner über MCP nutzt. Die KI fragt Ihre Tabelle — nicht sich selbst — nach der Antwort.',
      point1: 'KI sendet Parameter an Ihr Excel-Modell',
      point2: 'Excel-Formeln berechnen das echte Ergebnis',
      point3: 'KI präsentiert die präzise Antwort natürlich',
      youAsk: 'Sie fragen Claude:',
      question: 'Wie hoch wäre meine monatliche Rate für eine Hypothek über 300.000 $ bei 4,5 % über 30 Jahre?',
      claudeCalls: 'Claude ruft Ihren MCP Server auf:',
      claudeResponds: 'Claude antwortet mit dem Excel-Ergebnis:',
      response: 'Basierend auf Ihrem Kreditrechner beträgt Ihre monatliche Rate <strong>$1.520,06</strong>. Über 30 Jahre zahlen Sie insgesamt $547.220,13, davon $247.220,13 Zinsen.',
    },
    learnMore: {
      title: 'Mehr erfahren',
      devGuide: 'MCP-Protokoll: Entwickler-Leitfaden',
      devGuideDesc: 'Tiefgehender Einblick in die MCP-Einrichtung mit Codebeispielen und Best Practices.',
      claudeGuide: 'Claude Desktop + Excel Anleitung',
      claudeGuideDesc: 'Schritt-für-Schritt-Anleitung zur Verbindung von Claude Desktop mit Ihren Tabellen.',
      excelToApi: 'Excel-zu-API-Leitfaden',
      excelToApiDesc: 'Wandeln Sie jede Tabelle in Minuten in eine REST API um. Alternativen vergleichen.',
    },
    faq: {
      ...
      items: [
        {
          ...
          answer: 'MCP (Model Context Protocol) ist ein offener Standard, der es KI-Assistenten wie Claude und ChatGPT ermöglicht, sich mit externen Tools und Datenquellen zu verbinden. Ein MCP Server dient als Brücke und ermöglicht KI den Zugriff auf Ihre Tabellenberechnungen in Echtzeit — ohne die Mathematik zu halluzinieren.',
        },
        {
          question: 'Wie funktioniert der MCP Server von SpreadAPI mit Excel?',
          answer: 'SpreadAPI verwandelt Ihre Excel-Tabelle in eine API. Der MCP Server stellt diese API für KI-Assistenten bereit. Wenn eine KI eine Kreditrate, ein Preisangebot oder ein Finanzmodell berechnen muss, ruft sie Ihre echten Excel-Formeln auf, statt das Ergebnis zu raten.',
        },
        {
          question: 'Welche KI-Assistenten unterstützen MCP?',
          answer: 'Claude Desktop, ChatGPT (über Plugins/Actions) und jeder MCP-kompatible Client kann sich mit SpreadAPI verbinden. Das Protokoll ist offen und wächst — regelmäßig fügen neue KI-Tools MCP-Unterstützung hinzu.',
        },
        {
          question: 'Muss ich Code schreiben, um MCP einzurichten?',
          answer: 'Nein. SpreadAPI generiert die MCP-Konfiguration automatisch. Sie laden Ihre Excel-Datei hoch, definieren Eingaben und Ausgaben und kopieren die MCP-Verbindungs-URL in Ihren KI-Assistenten. Die Einrichtung dauert unter 5 Minuten.',
        },
        {
          question: 'Sind meine Excel-Daten bei der Nutzung von MCP sicher?',
          answer: 'Ja. Die KI sieht nur die Ein-/Ausgabezellen, die Sie explizit definieren. Ihre Formeln, proprietäre Logik und andere Daten bleiben privat. Die gesamte Kommunikation ist mit TLS 1.3 verschlüsselt, und Sie können den Zugriff jederzeit widerrufen.',
        },
        {
          question: 'Was ist der Unterschied zwischen MCP und einer traditionellen API-Integration?',
          answer: 'Eine traditionelle API erfordert, dass Entwickler Code schreiben, um Endpunkte aufzurufen. MCP ermöglicht KI-Assistenten, Ihre Tabellenberechnungen automatisch zu entdecken und zu nutzen — kein Code auf der KI-Seite nötig. Die KI versteht, welche Eingaben benötigt werden und welche Ausgaben zu erwarten sind.',
        },
        {
          question: 'Kann ich MCP für Finanzmodelle und Preisrechner verwenden?',
          answer: 'Absolut. MCP ist ideal für jedes Szenario, in dem KI präzise Berechnungen benötigt: Kreditpreise, Versicherungsangebote, Steuerberechnungen, Ingenieurformeln, ROI-Modelle und mehr. Die Excel-Engine garantiert eine Präzision, die LLMs nicht liefern können.',
        },
        {
          question: 'Wie schnell sind MCP-Berechnungen?',
          answer: 'SpreadAPI antwortet bei den meisten Berechnungen in 50–200 ms. Die Excel-Engine bleibt im Speicher aktiv, sodass es keine Kaltstartzeiten gibt. Das ist schnell genug für Echtzeit-KI-Anwendungen im Gespräch.',
        },
      ],
    },
    cta: {
      title: 'Bereit, KI mit Ihren Tabellen zu verbinden?',
      description: 'Richten Sie Ihren MCP Server in 5 Minuten ein. Kostenlose Version verfügbar.',
      button: 'Kostenlos starten',
    },
  },
} as const;

// Helper function to get MCP Server translations
export function getMCPServerTranslations(locale: SupportedLocale) {
  if (locale === 'de') {
    return mcpServerPage.de;
  }
  return mcpServerPage.en;
}

// Excel to API page translations
export const excelToApiPage = {
  en: {
    hero: {
      subheading: 'No Coding Required',
      title: 'Excel to API: Turn Any Spreadsheet Into a',
      titleHighlight: 'REST API',
      description: 'Your Excel spreadsheet already has the business logic. SpreadAPI turns it into a production-ready REST API — no developers needed, no formulas to rewrite, no accuracy to lose.',
      ctaPrimary: 'Convert Your Excel — Free',
      ctaSecondary: 'See How It Works',
    },
    problem: {
      title: 'The Problem: Excel Logic',
      titleHighlight: 'Trapped in Spreadsheets',
      description: 'Your team spent months building complex Excel models — pricing calculators, financial projections, engineering formulas. Now your app needs those calculations. The traditional options are painful:',
      rewrite: {
        title: 'Rewrite in Code',
        description: "Weeks of developer time. Formulas get mistranslated. Business users can't update the logic without a code release.",
      },
      googleSheets: {
        title: 'Google Sheets API',
        description: 'Requires rebuilding in Google Sheets. 60 req/min rate limit. 2-5 second response times. Missing Excel-only features.',
      },
      msGraph: {
        title: 'Microsoft Graph',
        description: 'Azure AD setup, complex OAuth, Office 365 subscription. Slow responses. Overkill for calculation APIs.',
      },
    },
    howItWorks: {
      subheading: '3 Steps, 5 Minutes',
      title: 'How to Convert',
      titleHighlight: 'Excel to API',
      step1Title: 'Upload Your .xlsx File',
      step1Desc: 'Drag and drop your Excel file. SpreadAPI loads it into a server-side Excel engine that supports all formulas, VLOOKUP, INDEX/MATCH, pivot tables, and more. No conversion, no compatibility issues.',
      step2Title: 'Define Inputs & Outputs',
      step2Desc: 'Select cells that accept parameters (e.g., loan_amount, interest_rate) and cells that return results (e.g., monthly_payment, total_interest). SpreadAPI auto-generates a typed API schema.',
      step3Title: 'Publish & Call Your API',
      step3Desc: 'One click to publish. Your spreadsheet is now a live REST API. Call it from any language, any framework, any automation tool. Response time: 50-200ms.',
    },
    codeExample: {
      title: 'Call Your API',
      titleSuffix: 'From Anywhere',
      description: "Your Excel API works with any HTTP client. Here's a loan calculator example:",
      requestLabel: 'Request',
      responseLabel: 'Response (50-200ms)',
    },
    comparison: {
      title: 'SpreadAPI vs.',
      titleHighlight: 'Alternatives',
      columns: ['', 'SpreadAPI', 'Rewrite in Code', 'Google Sheets', 'MS Graph'],
      rows: [
      ...
      detailLink: 'Want a detailed comparison? See',
      detailLinkText: 'SpreadAPI vs Google Sheets API',
    },
    whoUsesThis: {
      title: 'Who Converts',
      titleHighlight: 'Excel to API',
      finance: 'Finance Teams',
      financeDesc: 'Pricing models, loan calculators, risk assessments. Keep the logic in Excel where analysts maintain it, expose results via API.',
      developers: 'Developers',
      developersDesc: 'Skip weeks of formula rewriting. Get a REST API with typed inputs/outputs, OpenAPI spec, and batch execution support.',
      noCode: 'No-Code Builders',
      noCodeDesc: 'Connect Excel calculations to Zapier, Make, n8n, or Bubble. Add powerful business logic to any automation workflow.',
    },
    faq: {
      title: 'Frequently Asked Questions',
      items: [
        ...
        },
        {
          ...
          answer: 'Yes. On the free tier you can create unlimited spreadsheet APIs and test them — each publish stays live for 6 hours. No credit card required to get started.',
        },
      ],
    },
    related: {
      title: 'Related',
      mcpServer: 'MCP Server for Excel',
      mcpServerDesc: 'Connect AI assistants to your spreadsheet calculations via MCP protocol.',
      howItWorks: 'How Excel API Works',
      howItWorksDesc: 'Step-by-step walkthrough of inputs, outputs, and the execution model.',
      stopRewriting: 'Stop Rewriting Excel in Code',
      stopRewritingDesc: 'Why reimplementing Excel formulas in JavaScript is a mistake.',
    },
    cta: {
      title: 'Your Excel Already Works. Make It an API.',
      description: 'Upload your spreadsheet, define inputs and outputs, publish. Takes 5 minutes.',
      button: 'Get Started Free',
    },
  },
  de: {
    hero: {
      subheading: 'Kein Code erforderlich',
      title: 'Excel zu API: Verwandeln Sie jede Tabelle in eine',
      titleHighlight: 'REST API',
      description: 'Ihre Excel-Tabelle enthält bereits die Geschäftslogik. SpreadAPI macht daraus eine produktionsreife REST API — ohne Entwickler, ohne Formeln umzuschreiben, ohne Genauigkeit zu verlieren.',
      ctaPrimary: 'Excel konvertieren — kostenlos',
      ctaSecondary: 'So funktioniert es',
    },
    problem: {
      title: 'Das Problem: Excel-Logik',
      titleHighlight: 'in Tabellen gefangen',
      description: 'Ihr Team hat Monate damit verbracht, komplexe Excel-Modelle zu erstellen — Preisrechner, Finanzprognosen, Ingenieurformeln. Jetzt benötigt Ihre App diese Berechnungen. Die traditionellen Optionen sind mühsam:',
      rewrite: {
        title: 'In Code umschreiben',
        description: 'Wochen an Entwicklerzeit. Formeln werden falsch übersetzt. Fachanwender können die Logik nicht ohne Code-Release aktualisieren.',
      },
      googleSheets: {
        title: 'Google Sheets API',
        description: 'Erfordert Neuerstellung in Google Sheets. 60 Anfragen/Min Limit. 2-5 Sekunden Antwortzeit. Fehlende Excel-exklusive Funktionen.',
      },
      msGraph: {
        title: 'Microsoft Graph',
        description: 'Azure-AD-Einrichtung, komplexes OAuth, Office-365-Abonnement. Langsame Antworten. Überdimensioniert für Berechnungs-APIs.',
      },
    },
    howItWorks: {
      subheading: '3 Schritte, 5 Minuten',
      title: 'So konvertieren Sie',
      titleHighlight: 'Excel zu API',
      step1Title: 'Ihre .xlsx-Datei hochladen',
      step1Desc: 'Ziehen Sie Ihre Excel-Datei per Drag & Drop. SpreadAPI lädt sie in eine serverseitige Excel-Engine, die alle Formeln, SVERWEIS, INDEX/VERGLEICH, Pivot-Tabellen und mehr unterstützt. Keine Konvertierung, keine Kompatibilitätsprobleme.',
      step2Title: 'Eingaben & Ausgaben definieren',
      step2Desc: 'Wählen Sie Zellen, die Parameter akzeptieren (z. B. kreditbetrag, zinssatz) und Zellen, die Ergebnisse liefern (z. B. monatsrate, gesamtzinsen). SpreadAPI generiert automatisch ein typisiertes API-Schema.',
      step3Title: 'Veröffentlichen & API aufrufen',
      step3Desc: 'Ein Klick zum Veröffentlichen. Ihre Tabelle ist jetzt eine Live-REST-API. Rufen Sie sie von jeder Sprache, jedem Framework, jedem Automatisierungstool auf. Antwortzeit: 50–200 ms.',
    },
    codeExample: {
      title: 'Rufen Sie Ihre API',
      titleSuffix: 'von überall auf',
      description: 'Ihre Excel-API funktioniert mit jedem HTTP-Client. Hier ein Kreditrechner-Beispiel:',
      requestLabel: 'Anfrage',
      responseLabel: 'Antwort (50–200 ms)',
    },
    comparison: {
      title: 'SpreadAPI vs.',
      titleHighlight: 'Alternativen',
      columns: ['', 'SpreadAPI', 'In Code umschreiben', 'Google Sheets', 'MS Graph'],
      rows: [
        ['Einrichtungszeit', '5 Min.', 'Wochen', 'Stunden', 'Tage'],
        ['Nutzt Ihre Excel-Datei', 'Ja', 'Nein', 'Nein', 'Teilweise'],
        ['Antwortzeit', '50–200 ms', 'Variiert', '2–5 s', '2–5 s'],
        ['Rate Limits', 'Großzügig', 'Individuell', '60/Min.', '10.000/Tag'],
        ['Formelgenauigkeit', '100 %', 'Fehlerrisiko', '~95 %', '100 %'],
        ['KI/MCP-fähig', 'Ja', 'Manuell', 'Nein', 'Nein'],
        ['Fachanwender können aktualisieren', 'Ja', 'Nein', 'Ja', 'Ja'],
      ],
      detailLink: 'Detaillierter Vergleich gewünscht? Siehe',
      detailLinkText: 'SpreadAPI vs. Google Sheets API',
    },
    whoUsesThis: {
      title: 'Wer konvertiert',
      titleHighlight: 'Excel zu API',
      finance: 'Finanzteams',
      financeDesc: 'Preismodelle, Kreditrechner, Risikobewertungen. Die Logik bleibt in Excel, wo Analysten sie pflegen — Ergebnisse werden per API bereitgestellt.',
      developers: 'Entwickler',
      developersDesc: 'Überspringen Sie wochenlange Formelübersetzung. Erhalten Sie eine REST API mit typisierten Ein-/Ausgaben, OpenAPI-Spec und Batch-Ausführung.',
      noCode: 'No-Code-Entwickler',
      noCodeDesc: 'Verbinden Sie Excel-Berechnungen mit Zapier, Make, n8n oder Bubble. Fügen Sie leistungsstarke Geschäftslogik zu jedem Automatisierungs-Workflow hinzu.',
    },
    faq: {
      title: 'Häufig gestellte Fragen',
      items: [
        {
          question: 'Wie konvertiere ich eine Excel-Tabelle in eine API?',
          answer: 'Laden Sie Ihre Excel-Datei auf SpreadAPI hoch, definieren Sie, welche Zellen Eingaben und Ausgaben sind, und klicken Sie auf Veröffentlichen. Ihre Tabelle ist jetzt als REST-API-Endpunkt verfügbar, der JSON-Anfragen akzeptiert und berechnete Ergebnisse zurückgibt.',
        },
        {
          question: 'Unterstützt SpreadAPI alle Excel-Formeln?',
          answer: 'SpreadAPI unterstützt die meisten Excel-Formeln, einschließlich SVERWEIS, INDEX/VERGLEICH, SUMMEWENNS, Finanzfunktionen (RMZ, IKV, NBW), statistische Funktionen und komplexe verschachtelte Formeln. Pivot-Tabellen und Diagramme werden ebenfalls unterstützt.',
        },
        {
          question: 'Wie unterscheidet sich das von der Google Sheets API?',
          answer: 'Die Google Sheets API erfordert ein Google-Konto, hat ein Limit von 60 Anfragen/Minute und erfordert die Neuerstellung Ihrer Tabellen im Google-Sheets-Format. SpreadAPI arbeitet mit nativen Excel-Dateien, antwortet in 50–200 ms und unterstützt komplexe Excel-exklusive Funktionen wie Power-Query-Referenzen.',
        },
        {
          question: 'Kann ich meine bestehenden Excel-Dateien ohne Änderungen verwenden?',
          answer: 'Ja. Laden Sie Ihre .xlsx-Datei so hoch, wie sie ist. SpreadAPI führt Ihre Formeln serverseitig mit einer vollständig Excel-kompatiblen Engine aus. Kein Umschreiben von Formeln oder Umstrukturieren Ihrer Tabelle nötig.',
        },
        {
          question: 'Was ist mit der Microsoft Graph Excel API?',
          answer: 'Microsoft Graph erfordert ein Office-365-Abonnement, Azure-AD-Einrichtung und komplexe OAuth-Flows. Antwortzeiten liegen typischerweise bei 2–5 Sekunden. SpreadAPI ist eine einfachere Alternative: hochladen, Parameter definieren, veröffentlichen. Kein Microsoft-Konto nötig, 50–200 ms Antwortzeiten.',
        },
        {
          question: 'Gibt es eine kostenlose Version?',
          answer: 'Ja. In der kostenlosen Version können Sie beliebig viele Tabellen-APIs erstellen und testen — jeder Publish bleibt 6 Stunden live. Keine Kreditkarte erforderlich.',
        },
      ],
    },
    related: {
      title: 'Verwandt',
      mcpServer: 'MCP Server für Excel',
      mcpServerDesc: 'Verbinden Sie KI-Assistenten über das MCP-Protokoll mit Ihren Tabellenberechnungen.',
      howItWorks: 'Wie die Excel-API funktioniert',
      howItWorksDesc: 'Schritt-für-Schritt-Anleitung zu Eingaben, Ausgaben und dem Ausführungsmodell.',
      stopRewriting: 'Excel nicht mehr in Code umschreiben',
      stopRewritingDesc: 'Warum die Neuimplementierung von Excel-Formeln in JavaScript ein Fehler ist.',
    },
    cta: {
      title: 'Ihr Excel funktioniert bereits. Machen Sie eine API daraus.',
      description: 'Tabelle hochladen, Eingaben und Ausgaben definieren, veröffentlichen. Dauert 5 Minuten.',
      button: 'Kostenlos starten',
    },
  },
} as const;

// Helper function to get Excel to API translations
export function getExcelToApiTranslations(locale: SupportedLocale) {
  if (locale === 'de') {
    return excelToApiPage.de;
  }
  return excelToApiPage.en;
}
