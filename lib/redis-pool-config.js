...
// Redis provider limit (1024 connections based on your upgraded plan)
const REDIS_PROVIDER_LIMIT = 1024;
const RESERVED_CONNECTIONS = 24; // Reserve for monitoring, admin, one-off scripts (increased proportionally)
const USABLE_CONNECTIONS = REDIS_PROVIDER_LIMIT - RESERVED_CONNECTIONS; // 1000
...
export const poolConfig = {
  ...
  development: {
    minConnections: 2,
    maxConnections: Math.min(50, Math.floor(USABLE_CONNECTIONS / 20)), // Max 50 for dev (increased from 20)
  ...
  production: {
    ...
    maxWaitingClients: 5000, // Increased from 1000
